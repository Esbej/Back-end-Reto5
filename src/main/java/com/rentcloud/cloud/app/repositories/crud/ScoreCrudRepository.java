...
public interface ScoreCrudRepository extends CrudRepository<score,Integer> {//se hace referencia a la entidad que va a implementar el crud y el tipo de llave primaria Integer
